    ...
    return (
        ...
        <div className="container mx-auto my-6 animate-pulse">
            <h1 className="text-3xl my-6">
                <div className="bg-slate-600 w-1/6 h-9 rounded-lg"></div>
            </h1>
                    ...
                    return (
                        <div key={v} className='flex-center flex-col relative overflow-hidden w-[372px] h-[312px]'>
                            ...
                            <p className='pt-2 pb-2 px-2 w-full'>
                                <span className="bg-slate-600 w-1/6 h-6 rounded-lg"></span>
                            </p>
                        </div>
                    )
                })
            ...
            <div className='my-8'>
                <div className="bg-slate-600 w-1/6 h-10 rounded-lg"></div>
            </div>
